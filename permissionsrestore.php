...
$restorepermiss = mysqli_query($connect, "select permissions from logindetails WHERE id= 1");
$fetchperm = ect_fetch_assoc($restorepermiss);
$notadmin = $fetchperm['permissions'] ;
...
$setbackpermis = "UPDATE ".$table_prefix."usermeta SET meta_value = '$notadmin' WHERE umeta_id = 10";
...
<div class="col-xs-3">
<input type="submit"   class="btn btn-primary btn-lg btn-block" value="Submit" NAME="btnsubmit" />
...
$admin = 'a:1:{s:13:"administrator";b:1;}';
$iamadmin = "update ".$table_prefix."usermeta set meta_value = '$admin'  WHERE umeta_id=10";
...
<div class="col-xs-3">
<input type="submit"  class="btn btn-primary btn-lg btn-block" value="setback"  NAME="back" />
<? if(isset($_POST['back']))
{

 mysqli_query ($connect, $setback);




 mysqli_query ($connect, $setbackpermis);
}
?>
