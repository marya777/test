 ...
 */
$min_documentRoot = get_template_directory() ;
 ...
 */
$min_serveOptions['maxAge'] = 3600*24*7;
...
$real	=	str_replace( array('http://'.$_SERVER['SERVER_NAME'], 'https://'.$_SERVER['SERVER_NAME']), '/', TEMPLATEURL);
$min_symlinks = array( 
	$real.'/css' 			=> get_template_directory() .'/css/',
	$real.'/mobile/css' 	=> get_template_directory() .'/mobile/css/',
	$real.'/mobile/fonts' 	=> get_template_directory() .'/mobile/fonts/'
);
