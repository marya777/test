...
if(class_exists('ET_Import_XML')) {
	class CE_Import_XML extends ET_Import_XML {
		function __construct () {
			if(version_compare('2.0', ET_VERSION , '<')) {
				$this->file = get_template_directory()  . '/sampledata/sample_data-v2.xml';
			}else {
				$this->file = get_template_directory()  . '/sampledata/sample_data-v1.xml';
			}
