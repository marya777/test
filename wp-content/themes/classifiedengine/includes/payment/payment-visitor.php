...
if ( class_exists( "WooCommerce" ) ) {
    require_once get_template_directory().'/includes/wc_integrate/payment/ET_WC_Order.php';
    require_once get_template_directory().'/includes/wc_integrate/payment/ET_WC_Package.php';
    require_once get_template_directory().'/includes/wc_integrate/payment/WC_Integrate_Visitor.php';
}
...
class ET_PaypalVisitor extends ET_PaymentVisitor
{
    ...
    function setup_checkout ( ET_Order $order )
    {
        ...
        $notifyURL = '&notify_url='.urlencode( add_query_arg( 'paypalListener', 'paypal_standard_IPN', trailingslashit( home_url() ) ) );
