            ...
            <?php }    ?>
                <form id="form_auth" method="post" action="">
                    <div class="social-form">
                        ...
                        <input type="password" name="user_pass" required  placeholder="<?php _e('Password', ET_DOMAIN) ?>">
                        <input type="submit" value="Submit">
                    </div>
                </form>
            </div>
            <div class="social-auth social-auth-step2" style="display:none;">
                ...
                <form id="form_username" method="post" action="">
                    <div class="social-form">
                        <input type="hidden" name="et_nonce" value="<?php echo wp_create_nonce( 'authentication' ) ?>">
                        <input type="text" name="user_login" required value="<?php echo isset($auth['user_login']) ? $auth['user_login'] : "" ?>" placeholder="<?php _e('Username', ET_DOMAIN) ?>">
                        <input type="submit" value="Submit">
                    </div>
                </form>
            </div>
