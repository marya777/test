(function ($) {
	$(document).ready(function () {
		...
		$('#et_full_location').blur(function(event){
		...
		if($('#et_sellers').length > 0){
			var sellers	=	JSON.parse(jQuery('#et_sellers').html());
		...
		$('#' + edit_ad.regular_price).keyup(function(){
			var price	=	$('#' + edit_ad.regular_price ).val();
