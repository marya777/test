...
;(function($) {
	...
	$.fancybox.init = function() {
		...
		outer.append(
			...
			nav_left = $('<a href="javascript:;" id="fancybox-left"><span class="fancy-ico icon" id="fancybox-left-ico" data-icon ="[" ></span></a>'),
			nav_right = $('<a href="javascript:;" id="fancybox-right"><span class="fancy-ico icon" id="fancybox-right-ico" data-icon ="]"></span></a>')
		);
