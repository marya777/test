<?php 
class ET_MenuExtensions extends ET_AdminMenuItem{
	...
	public function menu_view($args){	
			$feed_extensions = fetch_feed( 'http://www.enginethemes.com/?act=request_extension&theme=classifiedengine' ); 
			$feed_themes 	 = fetch_feed( 'http://www.enginethemes.com/?act=request_theme&theme=classifiedengine' );
		...
		<div class="et-main-header">
            <div id="extension_point" class="title font-quicksand"><?php _e('Extensions',ET_DOMAIN) ?></div>
            <div class="desc"><?php _e('Check out these extensions for your forums from EngineThemes', ET_DOMAIN) ?></div>
