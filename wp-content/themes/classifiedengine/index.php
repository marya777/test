...
<div class="title-page">
	<div class="main-center container">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
              		<span class="customize_heading text customize_heading text-heading-home" >
                        <?php if( $wp_query->found_posts > 0 ) printf(__('%s Active Classifieds',ET_DOMAIN),$wp_query->found_posts);   ?>
                    </span>
                </div>
                <div class="col-md-9">
                    <!-- order search list -->
	...
	<div class="row">
        ...
        <?php
            ...
            if( is_home () && current_user_can( 'manage_options' ) ) {
                // includes template list template/list-pending.php
                get_template_part( 'template/list' , 'pending' );
            }
        ?>

        <?php if(have_posts()) : ?><h1 class="title-product"><?php _e("Latest Classifieds", ET_DOMAIN); ?></h1> <?php endif; ?>
...
<script type="application/json" id="publish_ads">
    <?php echo json_encode($publish_list); ?>
</script>
<script type="application/json" id="pending_ads">
    <?php    echo json_encode($pending_list); ?>
</script>
